...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-[100dvh] bg-background">
      {/* Navbar */}
      <header className="px-6 py-4 border-b border-white/5 flex items-center justify-between sticky top-0 bg-background/80 backdrop-blur-md z-50">
        <div className="flex items-center gap-3">
          <Brand />
          <div className="hidden w-8 h-8 bg-primary/20 rounded border border-primary/50 text-primary flex items-center justify-center">
          ...
          <span className="hidden font-bold text-lg tracking-tight sm:inline-block">AURA <span className="text-cyan-300">IA</span></span>
        </div>
      ...
      <main className="flex-1">
        ...
        <section className="relative pt-24 pb-32 overflow-hidden flex flex-col items-center text-center px-4">
          ...
          <h1 className="text-5xl md:text-7xl font-bold max-w-4xl tracking-tight leading-tight mb-8">
            Pare de digitar. <br/>
             Comece a <span className="aura-gradient-text">produzir resultados.</span>
          </h1>
          
          <p className="text-xl text-muted-foreground max-w-2xl mb-12">
             A AURA IA é uma plataforma premium onde criadores, profissionais de marketing e programadores encontram, criam e refinam prompts de alto impacto.
          </p>
        ...
        <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-card/70 border-white/5 p-8 flex flex-col items-start hover:border-primary/50 transition-colors">
      ...
      <footer className="bg-background border-t border-white/10 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center gap-2 mb-4 md:mb-0">
            ...
            <Brand compact />
            <span className="font-bold">AURA IA &copy; 2026</span>
          </div>
